...
<div class="container">
    ...
    <div class="row d-flex justify-content-center align-items-center" style="height: 50vh;">
        ...
        <form action="<?php echo Config::getInstance()->url;?>user/authorization"
        method="post" class="col-12 col-md-4">
            ...
            <!-- Link to register -->
            <p class="mt-4">Don't have an account? <a href="<?php echo Config::getInstance()->url;?>user/register">Register</a></p>
        </form>
    </div>
</div>