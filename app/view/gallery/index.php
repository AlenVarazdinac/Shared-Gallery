<div class="container">
    ...
    <div class="row mt-5 d-flex justify-content-center">
        <form action="<?php echo Config::getInstance()->_url;?>gallery/upload" method="post" enctype="multipart/form-data">
    ...
    <div class="row mt-5 d-flex justify-content-center">
        <?php foreach($images as $image): ?>
            <div class="card m-2" style="width: 18rem;">
                <img src="<?php echo Config::getInstance()->_url . 'public/gallery_images/' . $image['uploaded_by'] . '/gallery_' . $image['name'] . '.jpg';?>"
                ...
                <div class="card-body">
                    <a href="<?php echo Config::getInstance()->_url . 'gallery/remove/' . $image['userid'] . '/' . $image['name'];?>" class="card-link">Remove</a>
                </div>
                <?php endif;?>
            </div>
        <?php endforeach;?>
